...
namespace watch360
{
	public class OrbitCamera : MonoBehaviour 
	{
		...
		//
		public Vector2 m_RotateSpeed = new Vector2( 0.01f, 0.01f );
		//
		// 环绕仰角的最小值
		...
		private float m_fInitFieldOfView;
		#endregion
		...
		public float FieldOfView{set{m_fFieldOfView = value;}get {return m_fFieldOfView;}}
		#endregion
		...
		//
		public void Reset( float fFieldOfView, Vector3 vInitRot )
		{

			m_fFieldOfView = fFieldOfView;

			m_fInitFieldOfView = fFieldOfView;
		...
		private void Start ()
		{
			...
			m_fInitFieldOfView = Camera.main.fieldOfView;

			m_fFieldOfView = m_fInitFieldOfView;
		...
		private void LateUpdate()
		{
			...
			{
				Vector3 vec = m_vLastMousePos - Input.mousePosition;
			...
			if( Input.GetAxis("Mouse ScrollWheel") < 0 )
			{
				...
				this.FieldOfView = Mathf.Clamp( this.FieldOfView, MinZoom, MaxZoom );
			}
